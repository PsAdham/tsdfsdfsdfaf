...
message.channel.send('**Bot Orders\n----------------------------\n | ``$Profiles`` ➺ أوامـر الـبـروفـايـل\n | ``$ublic`` ➺ أوامـر الـعـامـة\n | ``$Admin`` ➺ أوامـر الأدمـن\n | ``$Giveaway`` ➺ أوامـر الجـيـفـاواي\n | ``$Protection`` ➺ أوامـر الـحـمـايـة\n | ``$Tickets`` ➺ أوامـر الـتـيـكـيـت\n | ``$Submit`` ➺ أوامـر الـتـقـديـم\n | ``$Games`` ➺ أوامـر الألـعـاب\n | ``$About`` ➺ أوامـر مـعـلـومـات الـبـوت\n-----------------------------**')
  }
   });
...
if (message.content === prefix+'Profiles') {
      message.author.send('** | Profile Menu\n----------------------------\n | ``$profile`` ⇏ لـعـرض الـبـروفـايـل الـخـاص بـك\n\n | ``$note`` ⇏ لـوضـع سـيـرة ذاتـيـة لـبـروفـايـلـك\n\n | ``$rep`` ⇏ لأعطـاء ريـب لـشـخـص\n\n | ``$credits`` ⇏ لـرؤيـة الـكـريدت الـخـاص بـك\n\n | ``$daily`` ⇏ لاخـذ حـصـتـك الـيـومـيـة مـن الـكـريدت\n\n | ``$credit @mention amount`` ⇏ لـتـحويـل كـريدت لشـخـص اخر\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Public') {
      message.author.send('** | Public Menu\n----------------------------\n | ``$avatar`` ⇏ لـعـرض صـورتـك\n\n | ``$image`` ⇏ لـعـرض صـورة الـسـيرفـر\n\n | ``$user`` ⇏ لـرؤيـة مـعـلـومـاتـك \n\n | ``$server`` ⇏ لـرؤيـة مـعـلـومـات عـن الـسـيـرفـر\n\n | ``$allbots`` ⇏ لـمـعـرفـة كـم بـوت بالـسـيـرفـر\n\n | ``$colors`` ⇏ لـعـرض قـائـمـة الألـوان\n\n | ``$color`` ⇏ لاخـتـيـار لـون فـي الـسـيـرفـر\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Admin') {
      message.author.send('**| Admin Menu\n----------------------------\n | ``$uptime`` ⇏ لـمـعـرفـة كـم صـار الـبـوت شـغـال\n\n | ``$mute`` ⇏ لأعطـاء مـيـوت كـتـابـي\n\n | ``$unmute`` ⇏ لـفـك الـمـيـوت الـكـتـابـي\n\n | ``$kick`` ⇏ لأعـطـاء طـرد لـشـخـص\n\n | ``$ban`` ⇏ لـتـبـنـيد عـضـو\n\n | ``$unban`` ⇏ لـفـك الـبـانـد عـن عـضـو\n\n | ``$setnick`` ⇏ لـتـغـيـر اسـم عـضـو\n\n | ``$moveall`` ⇏ لـسـحـب جـمـيـع الأعـضـاء للـروم الـصـوتـي\n\n | ``$close`` ⇏ لـقـفـل الـشـات\n\n | ``$open`` ⇏ لـفـتـح الـشـات\n\n | ``$ct`` ⇏ لأنـشـاء روم كـتـابـي\n\n | ``%cv`` ⇏ لأنـشـاء روم صـوتـي\n\n | ``$clear`` ⇏ لـمـسـح عـدد مـعـيـن مـن الـرسـائـل\n---------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Giveaway') {
      message.author.send('** | Giveaway Menu\n----------------------------\n | ``$start`` ⇏ لـبـدا قـيـفـاواي\n | ``$reroll`` ⇏ لاعـادة اخـتـيـار فـائـز اخـر\n | ``$gend`` ⇏ لأنـهـاء الـقـيفـاواي\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Protection') {
      message.author.send('** | Protection Menu\n----------------------------\n | ``$antibots on`` ⇏ لـتـفـعـيـل مـانـع دخـول الـبـوتـات\n\n | ``$antibots off`` ⇏ لاغـلاق مـانـع دخـول الـبـوتـات\n\n | ``$settings limitsban`` ⇏ لـتـحـديـد عـدد أقـصـي للـبـانـد\n\n | ``$settings limitskick`` ⇏ لـتـحـديـد عـدد أقـصـي للـطـرد\n\n | ``$settings limitsroleC`` ⇏ لـتـحـديـد عـدد أقـصـي لأنـشـاء رول\n\n | ``$settings limitsroleD`` ⇏ لـتـحـديـد عـدد أقـصـي لـمـسـح رول\n\n | ``$settings limitschannelD`` ⇏ لـتـحـديـد عـدد أقـصـي لـمـسـح روم\n---------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Tickets') {
      message.author.send('** | Ticket Menu\n----------------------------\n | ``$new`` ⇏ لأنـشـاء تـذكـرة\n\n | ``$close`` ⇏ لـقـفـل تـذـكـرة\n\n | ``$add`` ⇏ لأضـافـة شـخـص للـتـذـكـرة\n\n | ``$remove`` ⇏ لأزالـة شـخـص مـن الـتـذكـرة\n\n | ``$mtickets`` ⇏ لـتـفـعـيـل واغـلاق خـاصـيـة فـتـح الـتـذاكـر\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Submit') {
      message.author.send('** | Submit Menu\n----------------------------\n | ``$room1`` ⇏ لأنـشـاء روم الـتـقـديـمـات\n\n | ``$room2`` ⇏ لأنـشـاء روم الـقـبـول والـرفـض\n\n | ``$submit`` ⇏ للـتـقـديـم عـلـي رتـبـة\n\n | ``$apply @user RoleName`` ⇏ لـقـبـول عـضـو\n\n | ``$reject @user`` ⇏ لـرفـض عـضـو\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'Games') {
      message.author.send('** | Game Menu\n----------------------------\n | ``$hl`` ⇏ لـعـبـة هـل تـعـلـم\n\n | ``$mr`` ⇏ لـعـبـة مـريـم\n\n | ``$e7`` ⇏ لـعـبـة احـزر الـفـريـق\n\n | ``$lw`` ⇏ لـعـبـة لـو خـيـروك\n\n | ``$3k`` ⇏ لـعـبـة عـقـاب\n\n | ``$kt`` ⇏ لـعـبـة كـت تـويـت\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'About') {
      message.author.send('| About Menu\n----------------------------\n | ``$bot`` ⇏ لـعـرض مـعـلـومـات عـن الـبـوت\n\n | ``$inv`` ⇏ لـدعـوة الـبـوت لـسـيـرفـرك\n\n | ``$support`` ⇏ لـعـرض سـيـرفـر الـدعـم الـفـنـي\n----------------------------**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'support') {
 /// حط رابط سيرفرك مكان YourServer Here
      message.author.send('**Bot Support\n- https://discord.gg/wrJuDSP**').catch(e => console.log(e.stack));
...
if (message.content === prefix+'inv') {
      ...
      message.author.send('**Bot Invite\n - https://discord.com/oauth2/authorize?client_id=751717404551151696&scope=bot&permissions=806495294**').catch(e => console.log(e.stack));
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('**⊃** **__ID __:**' , `»  ${client.user.id} ` , true)
			      .addField('**⊃** **__Prefix __:**' , `» [ ${prefix} ]` , true)
			      .addField('**⊃** **__Language__ :**' , `»  [ Java Script ] ` , true)
            .addField('**⊃** |** __Owner Bot__** :' , `» <@728216693288992779>` , true) 
    })
...
client.on("message", message => {
          ...
          if(!message.channel.guild) return;
   if(message.author.bot) return;
      if(message.content === prefix + "avt server"){ 
          const embed = new Discord.RichEmbed()
...
if(message.content.startsWith(prefix + "user")) {
	...
	.addField('**JoinDiscord: **', `» ${joineddiscord}` ,true)
...
client.on('message', message => {
  ...
  .setFooter('Requested by '+message.author.username, message.author.avatarURL)
  .setDescription(`**Done Give You This Color**`)
...
client.on("message", luxy => {
  if (luxy.content === prefix + "close" || luxy.content === "قفل الشات") {
  ...
  if (luxy.content === prefix + "open" || luxy.content === "فتح الشات") {
    if (!luxy.channel.guild)
      return luxy.reply("<a:x30:714394016883540031> | **This command only for servers**");
...
client.on("message", async message => {
  ...
  if (args[0].toLowerCase() === `${prefix}heeeeelsasaollooop`) {
  ...
  } else if (args[0].toLowerCase() === `${prefix}closed`) {
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
    ...
    client.destroy();
  } else if (args[0].toLowerCase() === `${prefix}closea`) {
    let iq = 0;
...
client.on("message", message => {
  if (message.content == prefix + "submit") {
    ...
    if (!channel)
      return message.reply(
        " | **Type [ -room 1 ] To Make Room Submit.**"
      );
    if (channel) {
...
client.on("message", message => {
  if (message.content == prefix + "room 1") {
    ...
    message.channel.send(" | **تـم انـشـاء روم تـقـديـم**");
  }
});
client.on("message", async message => {
  ...
  if (message.content == prefix + "apply") {
    ...
    if (!acRoom)
      return message.reply(
        " | **Type [ -room 2 ] To Make Room Reject or Apply.**"
      );
    if (acRoom) {
      if (!message.guild.member(message.author).hasPermission("MANAGE_ROLES"))
        return;
      if (!mention) return message.reply(" | مـنـشـن الـعـضـو");
      if (!role) return message.reply(" | أدخـل اسـم رتـبـة");
      if (!mySupport) return message.reply(" | لـم أجـد هذة الـرتـبـة");
      if (mention.roles.has(mySupport))
        return message.reply(" | **هـذا الـشـخـص يـمـلـك الـرتـبـة**");

      mention.addRole(mySupport).then(() => {
        acRoom.send(
          `**[ ${mySupport} ] واعطـاءك رتـبـة ${mention} تـم قـبـولـك  **`
        );
      });
    }
  }
...
client.on("message", async message => {
  ...
  if (message.content == prefix + "reject") {
    ...
    acRoom.send(` | **${mention} تـم رفـضـك للأسـف**`);
  }
});
client.on("message", message => {
  if (message.content == prefix + "room2") {
    ...
    message.channel.send(" | **تـم انـشـاء روم الـقـبـول-الـرفـض**");
  }
});
